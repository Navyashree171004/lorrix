...
export function HowItWorksSection() {
  return (
    <section id="how-it-works" className="relative overflow-hidden bg-[hsl(226,88%,8%)] py-24">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <motion.div
                ...
                className="relative"
              >
                <div className="h-full rounded-lg border border-white/15 bg-white/10 p-6 text-center shadow-[0_18px_50px_-30px_hsl(220_90%_10%/0.7)] backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:bg-white/15">
                  {/* Icon Circle */}
